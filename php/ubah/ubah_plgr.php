                ...
                <div class="row">
                    <div class="col-md-7">
                        <div>
                            ...
                            <input type="text" class="form-control" id="jenis_plgr" placeholder="kedisiplinan, kerapian ..." name="jenis_plgr" required autocomplete="off" autofocus value="<?= $ktnplgr["jenis_pelanggaran"]; ?>">
                        </div>
                        <div class="mt-2">
                            <label for="det_plgr" class="form-label">Detail Pelanggaran</label>
                            <input type="text" class="form-control" id="det_plgr" name="det_plgr" required placeholder="datang terlambat ..." autocomplete="off" value="<?= $ktnplgr["det_pelanggaran"]; ?>">
                        </div>
                        <div class="mt-2">
                            <label for="poin" class="form-label">Poin Pelanggaran</label>
                            <input type="number" class="form-control" id="poin" name="poin" required placeholder="1 / 2 / ..." autocomplete="off" value="<?= $ktnplgr["poin_pelanggaran"]; ?>">
                        </div>
                        <div class="mt-4">
